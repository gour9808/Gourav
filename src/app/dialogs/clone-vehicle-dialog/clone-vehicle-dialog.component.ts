...
@Component({
  selector: 'app-clone-vehicle-dialog',
  templateUrl: './clone-vehicle-dialog.component.html',
  styleUrls: ['./clone-vehicle-dialog.component.scss']
})
export class CloneVehicleDialogComponent implements OnInit {
