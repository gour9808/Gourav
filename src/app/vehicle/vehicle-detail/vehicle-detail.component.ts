...
@Component({
  ...
  styleUrls: ['./vehicle-detail.component.scss', '../vehicle-create/vehicle-create.component.scss'],
...
export class VehicleDetailComponent implements OnInit {
  ...
  ngOnInit() {
    // this.vehicle = plainToClass(cbv.Vehicle.VehicleDetail, this.editData as Object);
  ...
  updateVehicle() {
    ...
    console.log(this.vehicle);
    console.log(Utils.pruneEmpty(this.vehicle));
    this.service.updatevehicleDetails(Utils.pruneEmpty(this.vehicle), this.vehicle.id).subscribe(res => {
      console.log(res);
      this.showDialog = (false);
      this.toasterService.pop('success', 'Update Vehicle', 'Vehicle Updated Successfully');
    }, error => {
      console.log(error);
      this.showDialog = (false);
      this.toasterService.pop('error', 'Update Vehicle', 'Error Updating vehicle ' + error);
    });
  }
