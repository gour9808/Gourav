...
@Component({
  selector: 'app-clone-dealer',
  templateUrl: './clone-dealer.component.html',
  styleUrls: ['./clone-dealer.component.scss'],
  encapsulation: ViewEncapsulation.None

})
export class CloneDealerComponent implements OnInit {
